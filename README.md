...
Not included by design: partial calls, DX cluster integration.
...
Install Java JDK/JRE 1.4+.

For rig control or CW keying, install the Java Communications API or RXTX (platform dependent).

Build using Ant if desired.

Refer to docs/HOWTO.txt if present.
